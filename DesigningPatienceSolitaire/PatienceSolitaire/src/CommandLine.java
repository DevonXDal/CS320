...
/**
 * This CommandLine class represents the view in an MVC pattern. It is the I/O handling class and receives input
...
public class CommandLine implements ICommandLine {
     ...
     *
     * Why: A summary of what was explained in the ICommandLine interface is that a chicken and egg situations happens when
