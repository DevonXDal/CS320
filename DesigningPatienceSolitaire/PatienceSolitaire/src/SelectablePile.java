...
/**
 * This SelectablePile class is an abstract version of the selectable piles that exist in Patience Solitaire.
 * Common functionality is set up in this location to reduce code duplication in the implementation.
 *
 * Why: The main reason for the SelectablePile abstract class is not necessarily to reduce code duplication. Its main purpose
