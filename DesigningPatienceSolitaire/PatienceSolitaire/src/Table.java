...
/**
 * This Table class represents the physical table space used to hold the components for the game Patience Solitaire.
...
public class Table {
     ...
     * arguments to their related piles that can be selectable.
     */
    public Table() {
